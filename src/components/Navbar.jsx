...
export const Navbar = () => {
    return (
        <header className='flex items-center justify-between px-2 sm:px-3 md:px-4 py-1 sm:py-2 border-b-4 fixed z-10 h-14 sm:h-15 md:h-16 w-full bg-slate-50 top-0 left-0'>
